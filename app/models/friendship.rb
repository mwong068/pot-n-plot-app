class Friendship < ApplicationRecord
    ...
    def self.create_reciprocal_for_ids(user_id, friend_id)
        ...
        user_friendship = Friendship.find_or_create_by(user_id: user_id, friend_id: friend_id)

        friend_friendship = Friendship.find_or_create_by(user_id: friend_id, friend_id: user_id)
